...
It provides deep learning models based on the **ResNet50** architecture for two specialized tasks in veterinary clinical pathology: comprehensive canine lymphoma analysis, including differential diagnosis between lymphoma and reactive lymphoid hyperplasia, and immunophenotype subtyping.
